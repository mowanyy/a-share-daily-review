...
stock_code_list = ['sh600601', 'sz002398', 'sh600789','sh600081','sh603815','sh603637','sh601921','sh603213','sh601878','sh603993',''] #在后面添加,' '即可，注意一定要用英文符号
...
# =====保存数据
# df.to_csv('muyi_stock_data.csv', index=False)
df.to_csv('muyi_stock_data.csv', index=False ,encoding="utf_8_sig")
